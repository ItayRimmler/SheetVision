...
def SheetVision(img_file):
    ...
    staff_lower, staff_upper, staff_thresh = 50, 150, 0.77  # * (np.sqrt(img_width * img_height) / 1000)
    sharp_lower, sharp_upper, sharp_thresh = 50, 150, 0.70  # * (np.sqrt(img_width * img_height) / 1000)
    flat_lower, flat_upper, flat_thresh = 50, 150, 0.77  # * (np.sqrt(img_width * img_height) / 1000)
    quarter_lower, quarter_upper, quarter_thresh = 50, 150, 0.70  # * (np.sqrt(img_width * img_height) / 1000)
    half_lower, half_upper, half_thresh = 50, 150, 0.70  # * (np.sqrt(img_width * img_height) / 1000)
    whole_lower, whole_upper, whole_thresh = 50, 150, 0.70  # * (np.sqrt(img_width * img_height) / 1000)
